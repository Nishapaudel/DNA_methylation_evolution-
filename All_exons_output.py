...
import sys
import py2bit
fout1 = open('exons_output.txt', 'w')

# print Headings
print("Chromosome","Feature","Start","End","Strand", "CpG_ratio", "Gpc_ratio" , end='\t', file = fout1)
    ...
    with open(gff_file) as fh:
        for line in fh:
            ...
            if feature == 'exon':
                ...
                #print(AA_ratio, AT_ratio AG_ratio , AC_ratio , TA_ratio , TT_ratio , TG_ratio , TC_ratio , GA_ratio , GT_ratio , GG_ratio , GC_ratio , CA_ratio , CT_ratio , CG_ratio , CC_ratio, sep = "\t", file = fout1)
